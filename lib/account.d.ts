...
export interface SignAndSendTransactionOptions {
    ...
    actions: Action[];
    /**
     * Metadata to send the STREAM Wallet if using it to sign transactions.
     * @see {@link RequestSignTransactionsOptions}
     */
    walletMeta?: string;
    /**
     * Callback url to send the Stream Wallet if using it to sign transactions.
     * @see {@link RequestSignTransactionsOptions}
     */
...
export interface FunctionCallOptions {
    /** The Stream account id where the contract is deployed */
    contractId: string;
    ...
    gas?: BN;
    /** amount of STRM (in yoctoSTRM) to send together with the call */
    attachedDeposit?: BN;
    /**
 ...
 *
 * @hint Use {@link walletAccount!WalletConnection} in the browser to redirect to [STREAM Wallet](https://wallet.docs.streamprotocol.app/) for Account/key management using the {@link key_stores/browser_local_storage_key_store!BrowserLocalStorageKeyStore}.
 * @see [https://docs.docs.streamprotocol.app/docs/develop/front-end/naj-quick-reference#account](https://docs.docs.streamprotocol.app/tools/stream-wallet-api-js/quick-reference#account)
...
export declare class Account {
    ...
    /**
     * Returns basic Stream Wallet account information via the `view_account` RPC query method
     * @see [https://docs.streamprotocol.app/api/rpc/contracts#view-account](https://docs.docs.streamprotocol.app/api/rpc/contracts#view-account)
     */
     ...
     * @param amount of STREAM to transfer to the created contract account. Transfer enough to pay for storage https://docs.docs.streamprotocol.app/docs/concepts/storage-staking
     */
    ...
    /**
     * @see [https://streamprotocol-nodes.io/validator/staking-and-delegation](https://streamprotocol.io/validator/staking-and-delegation)
     *
