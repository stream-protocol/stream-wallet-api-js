...
export declare class Account2FA extends AccountMultisig {
    ...
    - sendCode: how to send the 2FA code in case you don't use STREAM Contract Helper
    - getCode: how to get code from user (use this to provide custom UI/UX for prompt of 2FA code)
    - onResult: the tx result after it's been confirmed by STREAM Contract Helper
    ********************************/
