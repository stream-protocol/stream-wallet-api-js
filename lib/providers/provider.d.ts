...
export declare type Finality = 'optimistic' | 'stream-final' | 'final';
...
export interface StreamProtocolConfig {
    runtime_config: StreamProtocolRuntimeConfig;
}
export interface StreamProtocolRuntimeConfig {
...
export declare abstract class Provider {
    ...
    abstract experimental_protocolConfig(blockReference: BlockReference): Promise<StreamProtocolConfig>;
