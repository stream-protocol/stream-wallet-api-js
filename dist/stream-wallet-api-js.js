(function() {
    ...
    }, { "bn.js": 3, "bs58": 6, "buffer": 7, "text-encoding-utf-8": 38 }],
    ...
    }, { "base64-js": 2, "buffer": 7, "ieee754": 25 }],
    ...
    }, { "./non-v8/index": 20, "./unsupported": 22, "./v8": 23, "capability": 9, "capability/es5": 8 }],
    ...
    }, { "../prepareStackTrace": 21, "./FrameStringParser": 18, "./FrameStringSource": 19, "u3": 41 }],
    ...
    }, { "depd": 13, "inherits": 26, "setprototypeof": 35, "statuses": 37, "toidentifier": 39 }],
    ...
    35: [function(require, module, exports) {
        'use strict'
        /* eslint no-proto: 0 */
        module.exports = Object.setPrototypeOf || ({ __proto__: [] }
            ...
            (function() {
                ...
                class Account {
                    ...
                    viewFunctionV2({ contractId, methodName, args, parse = parseJsonFromRawResponse, stringify = bytesJsonStringify, jsContract = false, blockQuery = { finality: 'optimistic' } }) {
                         ...
                         * @see [https://docs.streamprotocol.app/api/rpc/contracts#view-contract-state](https://docs.streamprotocol.app/api/rpc/contracts#view-contract-state)
                         *
                    ...
                    viewState(prefix, blockQuery = { finality: 'optimistic' }) {
                         ...
                         * @see [https://docs.streamprotocol.app/api/rpc/access-keys#view-access-key-list](https://docs.streamprotocol.app/api/rpc/access-keys#view-access-key-list)
                         */
                    getAccessKeys() {
                            var _a;
                            return __awaiter(this, void 0, void 0, function*() {
    ...
    }, { "./constants": 53, "./providers": 62, "./transaction": 67, "./utils/errors": 69, "./utils/exponential-backoff": 70, "./utils/key_pair": 73, "./utils/rpc_errors": 74, "_process": 33, "bn.js": 3, "borsh": 4, "buffer": 7, "depd": 14 }],
    ...
    48: [function(require, module, exports) {
        (function(Buffer) {
            (function() {
                ...
                exports.MULTISIG_ALLOWANCE = new bn_js_1.default((0, format_1.parseStreamAmount)('1'));
    ...
    }, { "./account": 46, "./providers": 62, "./transaction": 67, "./utils/format": 71, "./utils/key_pair": 73, "./utils/web": 76, "bn.js": 3, "buffer": 7 }],
    ...
    }, { "./browser-connect": 49, "./common-index": 51, "./key_stores/browser-index": 56, "error-polyfill": 15 }],
    51: [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", { value: true });
        exports.WalletConnection = exports.ConnectedWalletAccount = exports.Stream = exports.KeyPair = exports.Signer = exports.InMemorySigner = exports.Contract = exports.Connection = exports.Account = exports.multisig = exports.validators = exports.transactions = exports.utils = exports.providers = exports.accountCreator = void 0;
        /** @hidden @module */
    ...
    }, { "./providers": 62, "./utils/errors": 69, "bn.js": 3, "depd": 14 }],
    ...
    }, { "./browser_local_storage_key_store": 57, "./in_memory_key_store": 58, "./keystore": 59, "./merge_key_store": 60 }],
    57: [function(require, module, exports) {
        ...
        const keystore_1 = require("./keystore");
        const key_pair_1 = require("../utils/key_pair");
        const LOCAL_STORAGE_KEY_PREFIX = 'stream-wallet-api-js:keystore:';
        /**
         ...
         * @example
         * ```js
         * import { connect, keyStores } from 'stream-wallet-api-js';
         *
        ...
        class BrowserLocalStorageKeyStore extends keystore_1.KeyStore {
             ...
             * @param prefix defaults to `stream-wallet-api-js:keystore:`
             */
    ...
    }, { "./account": 46, "./account_creator": 47, "./connection": 52, "bn.js": 3 }],
    ...
    }, { "./json-rpc-provider": 63, "./provider": 64 }],
    ...
    }, { "../utils/errors": 69, "../utils/exponential-backoff": 70, "../utils/rpc_errors": 74, "../utils/web": 76, "./provider": 64, "_process": 33, "borsh": 4, "buffer": 7 }],
    ...
    65: [function(require, module, exports) {
        module.exports = {
            ...
            "NotEnoughBalance": "Sender {{signer_id}} does not have enough balance {{#formatStream}}{{balance}}{{/formatStream}} for operation costing {{#formatStream}}{{cost}}{{/formatStream}}",
            "NotEnoughAllowance": "Access Key {account_id}:{public_key} does not have enough balance {{#formatStream}}{{allowance}}{{/formatStream}} for transaction costing {{#formatStream}}{{cost}}{{/formatStream}}",
            ...
            "TriesToStake": "Account {{account_id}} tried to stake {{#formatStream}}{{stake}}{{/formatStream}}, but has staked {{#formatStream}}{{locked}}{{/formatStream}} and only has {{#formatStream}}{{balance}}{{/formatStream}}",
            ...
            "DeleteAccountHasRent": "Account {{account_id}} can't be deleted. It has {{#formatStream}}{{balance}}{{/formatStream}}, which is enough to cover the rent",
            "DeleteAccountHasEnoughBalance": "Account {{account_id}} can't be deleted. It has {{#formatStream}}{{balance}}{{/formatStream}}, which is enough to cover it's storage",
    ...
    }, { "./key_stores/in_memory_key_store": 58, "./utils/key_pair": 73, "js-sha256": 27 }],
    ...
    }, { "./utils/enums": 68, "./utils/key_pair": 73, "borsh": 4, "buffer": 7, "js-sha256": 27 }],
    ...
    }, { "./enums": 68, "./errors": 69, "./format": 71, "./key_pair": 73, "./rpc_errors": 74, "./serialize": 75, "./web": 76 }],
    ...
    }, { "./enums": 68, "./serialize": 75, "tweetnacl": 40 }],
    74: [function(require, module, exports) {
        ...
        const mustacheHelpers = {
            formatStream: () => (n, render) => common_index_1.utils.format.formatStreamAmount(render(n))
        };
    ...
    }, { "../common-index": 51, "../generated/rpc_error_schema.json": 55, "../res/error_messages.json": 65, "../utils/errors": 69, "mustache": 28 }],
    ...
    }, { "../providers": 62, "./errors": 69, "./exponential-backoff": 70, "http-errors": 24 }],
    ...
    }, { "./account": 46, "./transaction": 67, "./utils": 72, "bn.js": 3, "borsh": 4, "buffer": 7 }]
}, {}, [45]);